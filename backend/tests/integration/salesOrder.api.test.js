...
describe(
  ...
  () => {
    ...
    test(
      "fails to create order without items",
      async () => {
        const response =
          await request(app)
            .post(
    ...
    test(
      "confirms the sales order and reduces stock",
      async () => {
        const response =
          await request(app)
            .post(
    ...
    test(
      "does not allow double confirmation",
      async () => {
        const response =
          await request(app)
            .post(
    ...
    test(
      ...
      async () => {
        ...
        const confirmResponse =
          await request(app)
            .post(
              `/api/sales-orders/${testOrder.id}/confirm`
            )
            .send();
